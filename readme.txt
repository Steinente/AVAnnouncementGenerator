...
1.1. Öffne die Datei `index.html` in deinem Webbrowser (z.B. Chrome, Firefox, Safari).
1.2. Du siehst vier Felder:
...
1.3. Klicke auf Vorschau, um die Ankündigung anzuzeigen.
1.4. Klicke auf Download, um die Ankündigung als Bilddatei herunterzuladen.
...
Um diese Einschränkung zu umgehen, besuche die Webseite cors-anywhere.herokuapp.com/corsdemo und klicke auf Request temporary access to the demo server. Dadurch erhältst du vorübergehend die Möglichkeit, Daten vom ARC abzufragen.

Vorgehen

2.1. Kopiere den Link eines Events von der Website AnimalRightsCalendar.
2.2. Klicke auf Aus ARC füllen.
2.3. Füge diesen Link in das Feld "ARC Event-Link" ein.
2.4. Klicke auf Füllen – die Felder werden automatisch mit den Informationen aus dem Event befüllt.

3. Standardwerte anpassen

3.1. Öffne die Datei app.js unter dem Ordner js in einem Texteditor (z.B. Notepad oder einem beliebigen einfachen Editor).
3.2. Ganz oben in der Datei findest du die Standardwerte, die bereits vorausgefüllt sind:
...
3.3. Ändere diese Werte nach deinen Wünschen, z.B. wenn du oft das gleiche Chapter, die gleiche Uhrzeit oder den gleichen Ort verwendest.
3.4. Diese Standardwerte werden dann automatisch in die entsprechenden Felder eingetragen, wenn sie leer bleiben. So musst du nur das Datum ändern, falls die anderen Felder immer gleich bleiben.
